...
CREATE TABLE `purchased_product` (
  ...
  CONSTRAINT `purchased_product_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order_items` (`id`),
  CONSTRAINT `purchased_product_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `purchased_product_ibfk_3` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
INSERT INTO `purchased_product` VALUES (2,1,1,1);
